...
import { getBarbershopsBySearchParams } from "@/app/_data/getBarbershopsBySearchParams"
import {
  FilterIcon,
  GridIcon,
  ListIcon,
...
export const metadata: Metadata = {
  title: "Barbearias | Siltec-Barber",
  description:
    "Encontre barbearias perto de você, compare serviços e preços e agende seu horário online pelo Siltec-Barber.",
}
